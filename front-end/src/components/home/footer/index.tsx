...
export default function Footer() {
  return (
    <footer className={styles.footerContainer} id="contato">
      ...
      <div className={styles.footerContent}>
        ...
        <div className={styles.footerCol}>
          <h3 className={styles.footerTitle}>Francisco Coelho</h3>
  ...
  >
    ...
    <circle cx="12" cy="10" r="3"></circle>
   </svg><span> R. Cinco de Abril,<br /> Velha Marabá, Marabá-PA<br /> 68500-040 </span></div>
          <div className={styles.contactItem}>
            {/* Ícone Telefone */}
        ...
        {/* Coluna 4: Horário */}
        <div className={styles.footerCol}>
          <h3 className={styles.footerTitle}>Horário de Visitação</h3>
      ...
      <div className={styles.footerBottom}>
        ...
        <div className={styles.socialIcons}>
          ...
          <a
            href="mailto:museufranciscocoelho@gmail.com"
            aria-label="Email"
          >
